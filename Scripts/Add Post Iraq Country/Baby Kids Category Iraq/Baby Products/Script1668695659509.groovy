...
Mobile.setText(findTestObject('Object Repository/Electronics/Send exampel by name'), 'مستلزمات أطفال', 30)

Mobile.tap(findTestObject('Baby Kids/Baby Products'), 30)
...
Mobile.clearText(findTestObject('Valid login and Click on Add post button/change phone number/android.widget.EditText - 962703213212'), 30)

Mobile.setText(findTestObject('Valid login and Click on Add post button/change phone number/android.widget.EditText -'), '7777777777', 30)

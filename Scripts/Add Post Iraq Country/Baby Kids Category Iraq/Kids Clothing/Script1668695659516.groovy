...
Mobile.setText(findTestObject('Object Repository/Electronics/Send exampel by name'), 'ملابس وأحذية للأطفال', 30)

Mobile.tap(findTestObject('Baby Kids/Kids Clothing'), 30)
...
def randomindexc = Math.abs(new Random().nextInt() % [1]) + 0

List six = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

six.get(randomindexc).click()
...
type.get(randomindexc).click()

WebUI.delay(2)

/////
List Color = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

Color.get(randomindexc).click()

WebUI.delay(2)

//////
List Size = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

Size.get(randomindexc).click()
...
List Brand = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

Brand.get(randomindexc).click()

...
Mobile.setText(findTestObject('Object Repository/Electronics/Send exampel by name'), 'كتب', 30)

Mobile.tap(findTestObject('Books and Hobbies/Books and Hobbies'), 30)

WebUI.delay(2)

Mobile.tap(findTestObject('Books and Hobbies/Musical'), 30)

Mobile.tap(findTestObject('Car and bikes/Next media step button'), 30)

Mobile.tap(findTestObject('Books and Hobbies/Type Music'), 30)

...
Mobile.setText(findTestObject('Object Repository/Electronics/Send exampel by name'), 'التنظيف', 30)

Mobile.tap(findTestObject('Business and Equipments/Cleaning Subblies'), 30)

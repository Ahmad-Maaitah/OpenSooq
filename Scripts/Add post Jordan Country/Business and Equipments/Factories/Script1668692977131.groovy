...
Mobile.setText(findTestObject('Object Repository/Electronics/Send exampel by name'), 'المصانع', 30)

Mobile.tap(findTestObject('Business and Equipments/Factories'), 30)

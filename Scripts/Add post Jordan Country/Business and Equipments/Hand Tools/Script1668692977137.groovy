...
Mobile.setText(findTestObject('Object Repository/Electronics/Send exampel by name'), 'يدويه', 30)

Mobile.tap(findTestObject('Business and Equipments/Hand Tools'), 30)

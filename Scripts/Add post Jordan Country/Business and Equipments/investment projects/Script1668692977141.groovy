...
Mobile.setText(findTestObject('Object Repository/Electronics/Send exampel by name'), 'استثما', 30)

Mobile.tap(findTestObject('Business and Equipments/investment projects'), 30)

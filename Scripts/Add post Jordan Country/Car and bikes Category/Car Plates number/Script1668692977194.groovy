...
Mobile.tap(findTestObject('Car for Rental/Car Plates Number'), 30)

Mobile.tap(findTestObject('Car and bikes/Next media step button'), 30)

Mobile.tap(findTestObject('Car for Rental/Plant city'), 30)

Mobile.tap(findTestObject('Car for Rental/Plant Area'), 30)

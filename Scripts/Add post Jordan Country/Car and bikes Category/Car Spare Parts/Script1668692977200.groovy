...
Mobile.tap(findTestObject('Car for Rental/Car Speaew parts'), 30)

Mobile.tap(findTestObject('Car and bikes/Next media step button'), 30)

Mobile.tap(findTestObject('Car for Rental/Type spear'), 30)

Mobile.tap(findTestObject('Car for Rental/subtypespear'), 30)

...
Mobile.setText(findTestObject('Object Repository/Electronics/Send exampel by name'), 'ثقيله', 30)

Mobile.tap(findTestObject('Car for Rental/Heavy Machinry'), 30)
...
List Heavytype = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

def randomindex = Math.abs(new Random().nextInt() % [3]) + 0

Heavytype.get(randomindex).click()

WebUI.delay(2)

List Heavysubtype = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

Heavysubtype.get(randomindex).click()

WebUI.delay(2)

List Heavyyear = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

Heavyyear.get(randomindex).click()

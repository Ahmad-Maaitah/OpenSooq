...
Mobile.setText(findTestObject('Object Repository/Electronics/Send exampel by name'), 'شاحنات', 30)

Mobile.tap(findTestObject('Car for Rental/Trucks and Trailers'), 30)
...
List Truckstype = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

def randomindex = Math.abs(new Random().nextInt() % [4]) + 0

Truckstype.get(randomindex).click()

WebUI.delay(2)

List Trucksmodel = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

Trucksmodel.get(randomindex).click()

WebUI.delay(2)

List Trucksyeres = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

Trucksyeres.get(randomindex).click()

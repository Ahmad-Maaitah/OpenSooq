...
Mobile.setText(findTestObject('Object Repository/Electronics/Send exampel by name'), 'جنطات', 30)

Mobile.tap(findTestObject('Car for Rental/Wheels and rims subcategory'), 30)
...
List rimstype = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

def randomindex = Math.abs(new Random().nextInt() % [4]) + 0

rimstype.get(randomindex).click()

WebUI.delay(2)

List rimssize = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

rimssize.get(randomindex).click()

WebUI.delay(2)

List rimsbrans = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

rimsbrans.get(randomindex).click()

...
Mobile.tap(findTestObject('Comuters And Laptops/Comuters and Labtops Catgory'), 30)

Mobile.tap(findTestObject('Comuters And Laptops/Laptops'), 30)

Mobile.tap(findTestObject('Car and bikes/Next media step button'), 30)

AppiumDriver<?> driver = MobileDriverFactory.getDriver()

List LabtopsBrand = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

def randomindex = Math.abs(new Random().nextInt() % [5]) + 0

LabtopsBrand.get(randomindex).click()

WebUI.delay(2)
/////

List LabtopsOS = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')
LabtopsOS.get(randomindex).click()

WebUI.delay(2)

////

List LabtopsScreenSize = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')
LabtopsScreenSize.get(randomindex).click()

WebUI.delay(2)

////
List LabtopsRam = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')
LabtopsRam.get(randomindex).click()

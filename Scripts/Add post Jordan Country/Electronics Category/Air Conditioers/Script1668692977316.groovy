...
Mobile.setText(findTestObject('Object Repository/Electronics/Send exampel by name'), 'Air Conditioners', 30)

Mobile.tap(findTestObject('Electronics/Air Conditioers'), 30)

Mobile.tap(findTestObject('Car and bikes/Next media step button'), 30)

AppiumDriver<?> driver = MobileDriverFactory.getDriver()

List AirConditionersBrand = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

def randomindex = Math.abs(new Random().nextInt() % [2]) + 0

AirConditionersBrand.get(randomindex).click()

WebUI.delay(2)

/////
List AirConditionerscapicity = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

AirConditionerscapicity.get(randomindex).click()

WebUI.delay(2)


/////
List AirConditionerstype = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

AirConditionerstype.get(randomindex).click()

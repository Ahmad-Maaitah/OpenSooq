...
Mobile.setText(findTestObject('Object Repository/Electronics/Send exampel by name'), 'Cameras', 30)

Mobile.tap(findTestObject('Electronics/Cameras -Photo'), 30)

Mobile.tap(findTestObject('Car and bikes/Next media step button'), 30)

AppiumDriver<?> driver = MobileDriverFactory.getDriver()

List cameraBrand = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

def randomindex = Math.abs(new Random().nextInt() % [2]) + 0

cameraBrand.get(randomindex).click()

WebUI.delay(2)

/////
List camerasubtype = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

camerasubtype.get(randomindex).click()

...
Mobile.tap(findTestObject('Electronics/Dishwashers'), 30)

Mobile.tap(findTestObject('Car and bikes/Next media step button'), 30)

AppiumDriver<?> driver = MobileDriverFactory.getDriver()

List Dishwashersbrand = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

def randomindex = Math.abs(new Random().nextInt() % [1]) + 0

Dishwashersbrand.get(randomindex).click()

WebUI.delay(2)

/////
List DishwashersCapacity = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

DishwashersCapacity.get(randomindex).click()

...
Mobile.setText(findTestObject('Object Repository/Electronics/Send exampel by name'), 'Ovens', 30)

Mobile.tap(findTestObject('Electronics/Ovens'), 30)

Mobile.tap(findTestObject('Car and bikes/Next media step button'), 30)

AppiumDriver<?> driver = MobileDriverFactory.getDriver()

List Ovenstype = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

def randomindex = Math.abs(new Random().nextInt() % [1]) + 0

Ovenstype.get(randomindex).click()

WebUI.delay(2)

/////
List Ovensbrand = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

Ovensbrand.get(randomindex).click()

...
Mobile.setText(findTestObject('Object Repository/Electronics/Send exampel by name'), 'Repair', 30)

Mobile.tap(findTestObject('Electronics/Repair Services'), 30)

Mobile.tap(findTestObject('Car and bikes/Next media step button'), 30)

AppiumDriver<?> driver = MobileDriverFactory.getDriver()

List RepairBrand = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

def randomindex = Math.abs(new Random().nextInt() % [1]) + 0

RepairBrand.get(randomindex).click()

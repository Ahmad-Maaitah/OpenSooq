...
Mobile.setText(findTestObject('Object Repository/Electronics/Send exampel by name'), 'Security', 30)

Mobile.tap(findTestObject('Electronics/Security And Surv'), 30)

Mobile.tap(findTestObject('Car and bikes/Next media step button'), 30)

AppiumDriver<?> driver = MobileDriverFactory.getDriver()

List SecurityBrand = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

def randomindex = Math.abs(new Random().nextInt() % [3]) + 0

SecurityBrand.get(randomindex).click()

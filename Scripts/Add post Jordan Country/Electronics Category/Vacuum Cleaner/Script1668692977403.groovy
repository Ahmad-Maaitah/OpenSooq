...
Mobile.setText(findTestObject('Object Repository/Electronics/Send exampel by name'), 'Vacuum Cleaner', 30)

Mobile.tap(findTestObject('Electronics/Vacuum Cleaner'), 30)

Mobile.tap(findTestObject('Car and bikes/Next media step button'), 30)

AppiumDriver<?> driver = MobileDriverFactory.getDriver()

List VacuumBrand = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

def randomindex = Math.abs(new Random().nextInt() % [2]) + 0

VacuumBrand.get(randomindex).click()

...
Mobile.setText(findTestObject('Object Repository/Electronics/Send exampel by name'), 'water - Solar', 30)

Mobile.tap(findTestObject('Electronics/Water -Solar Heater'), 30)

Mobile.tap(findTestObject('Car and bikes/Next media step button'), 30)

AppiumDriver<?> driver = MobileDriverFactory.getDriver()

List SolarBrand = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

def randomindex = Math.abs(new Random().nextInt() % [2]) + 0

SolarBrand.get(randomindex).click()

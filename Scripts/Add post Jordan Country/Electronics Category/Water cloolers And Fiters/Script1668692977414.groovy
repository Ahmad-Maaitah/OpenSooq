...
Mobile.setText(findTestObject('Object Repository/Electronics/Send exampel by name'), 'Water Coolers', 30)

Mobile.tap(findTestObject('Electronics/Water cloolers And Fiters'), 30)

Mobile.tap(findTestObject('Car and bikes/Next media step button'), 30)

AppiumDriver<?> driver = MobileDriverFactory.getDriver()

List CoolersBrand = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

def randomindex = Math.abs(new Random().nextInt() % [1]) + 0

CoolersBrand.get(randomindex).click()

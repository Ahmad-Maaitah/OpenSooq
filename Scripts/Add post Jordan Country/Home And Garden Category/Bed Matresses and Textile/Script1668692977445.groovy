...
Mobile.setText(findTestObject('Object Repository/Electronics/Send exampel by name'), 'فرشات', 30)

Mobile.tap(findTestObject('Home And Garden/Bed Matresses and Textile'), 30)

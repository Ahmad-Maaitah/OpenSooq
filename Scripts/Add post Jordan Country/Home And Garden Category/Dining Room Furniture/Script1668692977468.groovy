...
Mobile.setText(findTestObject('Object Repository/Electronics/Send exampel by name'), 'المنزل والحديقه', 30)

Mobile.tap(findTestObject('Home And Garden/Home And Garden'), 30)

Mobile.tap(findTestObject('Object Repository/Electronics/Search by name'), 30)

WebUI.delay(2)

Mobile.setText(findTestObject('Object Repository/Electronics/Send exampel by name'), 'أثاث غرف سفرة', 30)

Mobile.tap(findTestObject('Home And Garden/Dining Romm Furniture'), 30)

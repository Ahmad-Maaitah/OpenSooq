...
Mobile.setText(findTestObject('Object Repository/Electronics/Send exampel by name'), 'خدمات حدائق', 30)

Mobile.tap(findTestObject('Home And Garden/Gardening Services'), 30)

...
Mobile.setText(findTestObject('Object Repository/Electronics/Send exampel by name'), 'ادوات المطبخ', 30)

Mobile.tap(findTestObject('Home And Garden/Kitchen Tools'), 30)

...
Mobile.setText(findTestObject('Object Repository/Electronics/Send exampel by name'), 'اثاث غرف جلوس', 30)

Mobile.tap(findTestObject('Home And Garden/Living Room Furniture'), 30)

...
Mobile.setText(findTestObject('Object Repository/Electronics/Send exampel by name'), 'اثاث مكتبي ', 30)

Mobile.tap(findTestObject('Home And Garden/Office Furniture'), 30)

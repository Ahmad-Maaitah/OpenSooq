...
Mobile.setText(findTestObject('Object Repository/Electronics/Send exampel by name'), 'شراء ', 30)

Mobile.tap(findTestObject('Home And Garden/Other Home And Garfen'), 30)

...
Mobile.setText(findTestObject('Object Repository/Electronics/Send exampel by name'), 'اثاث خارجي', 30)

Mobile.tap(findTestObject('Home And Garden/Outdoor Furniture'), 30)

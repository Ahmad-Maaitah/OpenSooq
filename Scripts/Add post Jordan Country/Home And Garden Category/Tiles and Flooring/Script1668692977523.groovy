...
Mobile.setText(findTestObject('Object Repository/Electronics/Send exampel by name'), 'بلاط', 30)

Mobile.tap(findTestObject('Home And Garden/Tiles and Flooring'), 30)

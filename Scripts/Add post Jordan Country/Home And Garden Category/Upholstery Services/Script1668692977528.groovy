...
Mobile.setText(findTestObject('Object Repository/Electronics/Send exampel by name'), 'خدمات تنجيد', 30)

Mobile.tap(findTestObject('Home And Garden/Upholstery Services'), 30)

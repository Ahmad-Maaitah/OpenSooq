...
Mobile.setText(findTestObject('Object Repository/Electronics/Send exampel by name'), 'مستحضرات', 30)

Mobile.tap(findTestObject('Mens Fashion/Mens Personal Care'), 30)

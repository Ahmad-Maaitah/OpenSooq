...
Mobile.setText(findTestObject('Object Repository/Electronics/Send exampel by name'), 'موضه رجالي', 30)

Mobile.tap(findTestObject('Mens Fashion/Mens Fashion'), 30)

WebUI.delay(2)

Mobile.tap(findTestObject('Mens Fashion/Mens Watches'), 30)

Mobile.tap(findTestObject('Car and bikes/Next media step button'), 30)

AppiumDriver<?> driver = MobileDriverFactory.getDriver()

def randomindex = Math.abs(new Random().nextInt() % [3]) + 0
...
size.get(randomindex).click()

WebUI.delay(2)

/////
List subtype = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

subtype.get(randomindex).click()

...
Mobile.tap(findTestObject('Mens Fashion/Menswear'), 30)
...
//////
List sub = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

sub.get(randomindex).click()

...
Mobile.setText(findTestObject('Object Repository/Electronics/Send exampel by name'), 'شخصيه رجاليه', 30)

Mobile.tap(findTestObject('Mens Fashion/Personal Products'), 30)

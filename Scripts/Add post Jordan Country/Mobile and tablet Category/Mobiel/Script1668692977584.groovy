...
Mobile.tap(findTestObject('Mobile/Mobile subcategory'), 30)

Mobile.tap(findTestObject('Car and bikes/Next media step button'), 30)

AppiumDriver<?> driver = MobileDriverFactory.getDriver()

List MobileMake = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

def randomindex = Math.abs(new Random().nextInt() % [5]) + 0

MobileMake.get(randomindex).click()

WebUI.delay(2)

////////
List Mobilemodel = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

Mobilemodel.get(randomindex).click()

WebUI.delay(2)

////////
List Mobilestorge = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

Mobilestorge.get(randomindex).click()

WebUI.delay(2)

Mobile.tap(findTestObject('Motorcycles/Mobile color'), 30)

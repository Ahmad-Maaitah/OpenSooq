...
Mobile.tap(findTestObject('Mobile/tablit subcategory'), 30)

Mobile.tap(findTestObject('Car and bikes/Next media step button'), 30)

AppiumDriver<?> driver = MobileDriverFactory.getDriver()

List tabluitMake = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

def randomindex = Math.abs(new Random().nextInt() % [5]) + 0

tabluitMake.get(randomindex).click()

WebUI.delay(2)

////////
List tablitmodel = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

tablitmodel.get(randomindex).click()

WebUI.delay(2)

//////
List tablitstorge = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

tablitstorge.get(randomindex).click()

WebUI.delay(2)

//////
List tablitscrrensize = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

tablitscrrensize.get(randomindex).click()

WebUI.delay(2)

Mobile.tap(findTestObject('Mobile/Staus for mobile'), 30)

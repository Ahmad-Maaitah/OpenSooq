...
Mobile.tap(findTestObject('Motorcycles/Motorcycles Category'), 30)

Mobile.tap(findTestObject('Motorcycles/Motor subcategory'), 30)
...
List MotorMake = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

def randomindexx = Math.abs(new Random().nextInt() % [1]) + 0
def randomindex = Math.abs(new Random().nextInt() % [5]) + 0


MotorMake.get(randomindexx).click()
...
List MotorModel = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

MotorModel.get(randomindex).click()

WebUI.delay(2)

///////////////
List Motoryear = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

Motoryear.get(randomindex).click()

WebUI.delay(2)

Mobile.tap(findTestObject('Motorcycles/motor kilomiter'), 30)

Mobile.tap(findTestObject('Motorcycles/motot engel'), 30)

Mobile.tap(findTestObject('Motorcycles/motor condion'), 30)

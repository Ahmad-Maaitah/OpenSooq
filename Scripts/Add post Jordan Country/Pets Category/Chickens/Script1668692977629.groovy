...
Mobile.setText(findTestObject('Object Repository/Electronics/Send exampel by name'), 'حيوانات', 30)

Mobile.tap(findTestObject('Pets/Pets'), 30)

Mobile.tap(findTestObject('Pets/Chickens'), 30)

...
Mobile.tap(findTestObject('Real Estate for Rent/Foreign real estate for Rent'), 30)
...
List Country = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')
...
Country.get(randomindex).click()

WebUI.delay(2)

/////
List RealEstatetype = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

RealEstatetype.get(randomindex).click()

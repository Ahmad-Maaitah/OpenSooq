...
Mobile.setText(findTestObject('Object Repository/Electronics/Send exampel by name'), 'Lands', 30)

Mobile.tap(findTestObject('Real Estate for Rent/Lands for Rent'), 30)
...
List Zoneedfor = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')
...
Zoneedfor.get(randomindex).click()

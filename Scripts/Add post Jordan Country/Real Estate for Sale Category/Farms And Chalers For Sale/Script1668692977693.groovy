...
Mobile.setText(findTestObject('Object Repository/Electronics/Send exampel by name'), 'عقارات للبيع', 30)

Mobile.tap(findTestObject('Real Estate for Sale/Real Estate for sale Cat'), 30)

Mobile.tap(findTestObject('Object Repository/Electronics/Search by name'), 30)

Mobile.setText(findTestObject('Object Repository/Electronics/Send exampel by name'), 'Farms', 30)

Mobile.tap(findTestObject('Real Estate for Sale/Farms And Chalers For Sale'), 30)
...
/////
List Owner = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

Owner.get(randomindextest).click()

WebUI.delay(2)

//
List Proprtystatus = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

Proprtystatus.get(randomindextest).click()

WebUI.delay(2)

/////
List Mortgaged = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

Mortgaged.get(randomindextest).click()

WebUI.delay(2)

////
List fun = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

fun.get(randomindextest).click()

WebUI.delay(2)
////
List Paymentmethod = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

Paymentmethod.get(randomindextest).click()

...
Mobile.tap(findTestObject('Real Estate for Sale/Lands For sale'), 30)
...
List Zonedfor = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

WebUI.delay(2)

def randomindex = Math.abs(new Random().nextInt() % [4]) + 0

Zonedfor.get(randomindex).click()

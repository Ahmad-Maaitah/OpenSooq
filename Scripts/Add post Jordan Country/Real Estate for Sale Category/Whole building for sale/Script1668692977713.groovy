...
Mobile.setText(findTestObject('Object Repository/Electronics/Send exampel by name'), 'Whole', 30)

Mobile.tap(findTestObject('Real Estate for Sale/Whole building for sale'), 30)
...
List Floors = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

WebUI.delay(2)

def randomindex = Math.abs(new Random().nextInt() % [4]) + 0

Floors.get(randomindex).click()

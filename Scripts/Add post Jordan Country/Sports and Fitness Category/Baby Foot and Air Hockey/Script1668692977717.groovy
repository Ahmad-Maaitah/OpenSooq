...
Mobile.setText(findTestObject('Object Repository/Electronics/Send exampel by name'), 'بيبي', 30)

Mobile.tap(findTestObject('Sports and Fitness/Baby Foot and Air Hockey'), 30)

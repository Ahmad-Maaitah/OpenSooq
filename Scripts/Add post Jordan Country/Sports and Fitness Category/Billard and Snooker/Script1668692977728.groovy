...
Mobile.setText(findTestObject('Object Repository/Electronics/Send exampel by name'), 'بلياردو', 30)

Mobile.tap(findTestObject('Sports and Fitness/Billard and Snooker'), 30)

...
Mobile.setText(findTestObject('Object Repository/Electronics/Send exampel by name'), 'المضرب', 30)

Mobile.tap(findTestObject('Sports and Fitness/Racket Sports'), 30)

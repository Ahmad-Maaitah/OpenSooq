...
Mobile.setText(findTestObject('Object Repository/Electronics/Send exampel by name'), 'سكيت', 30)

Mobile.tap(findTestObject('Sports and Fitness/Skate and Scooters'), 30)

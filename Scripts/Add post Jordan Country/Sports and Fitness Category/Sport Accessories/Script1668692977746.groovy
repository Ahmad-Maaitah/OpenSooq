...
Mobile.setText(findTestObject('Object Repository/Electronics/Send exampel by name'), 'رياضه', 30)

Mobile.tap(findTestObject('Sports and Fitness/Sport And Fitness'), 30)
...
Mobile.setText(findTestObject('Object Repository/Electronics/Send exampel by name'), 'الاكسسوارات', 30)

Mobile.tap(findTestObject('Sports and Fitness/Sport Accessories'), 30)

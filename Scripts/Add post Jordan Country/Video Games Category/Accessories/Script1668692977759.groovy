...
Mobile.tap(findTestObject('Video Games/Vidio Games category'), 30)

Mobile.tap(findTestObject('Video Games/Accessories subcategory'), 30)

Mobile.tap(findTestObject('Car and bikes/Next media step button'), 30)

AppiumDriver<?> driver = MobileDriverFactory.getDriver()

List Gamingtype = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

def randomindex = Math.abs(new Random().nextInt() % [5]) + 0

Gamingtype.get(randomindex).click()

WebUI.delay(2)

///
List Gamingbrand = driver.findElementsByXPath('//androidx.recyclerview.widget.RecyclerView[1]/android.widget.FrameLayout/android.view.ViewGroup[1]/android.widget.TextView[1]')

Gamingbrand.get(randomindex).click()

...
Mobile.setText(findTestObject('Object Repository/Electronics/Send exampel by name'), 'موضة نسائية', 30)
...
Mobile.setText(findTestObject('Object Repository/Electronics/Send exampel by name'), 'عطور', 30)

Mobile.tap(findTestObject('Womens Fashion/Perfumes and Incense'), 30)

...
Mobile.tap(findTestObject('Valid login and Click on Add post button/Select country'), 30)

Mobile.tap(findTestObject('Valid login and Click on Add post button/Addpost icone'), 30)

Mobile.setText(findTestObject('Valid login and Click on Add post button/Phone2'), '0701991995', 30)

Mobile.tap(findTestObject('Valid login and Click on Add post button/Nextphone'), 30)

Mobile.setEncryptedText(findTestObject('Valid login and Click on Add post button/Password2'), 'aeHFOx8jV/A=', 30)

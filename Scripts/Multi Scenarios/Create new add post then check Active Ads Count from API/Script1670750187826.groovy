...
WebUI.callTestCase(findTestCase('Login Page/Valid login to check Account Detalis'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('General Cases/AccountDetails After Add post'), [:], FailureHandling.STOP_ON_FAILURE)

...
Mobile.setText(findTestObject('User Profile/EmailValue_EditProfile'), ' ', 0, FailureHandling.STOP_ON_FAILURE)
Mobile.pressBack()
Mobile.scrollToText('حفظ')
Mobile.tap(findTestObject('User Profile/SaveChange_UpdateProfile'), 5, FailureHandling.STOP_ON_FAILURE)
Mobile.verifyElementText(findTestObject('ValidationMessages_UpdateAccount/EmptyEmail_UpdateAccount'), 'لا يمكنك حذف بريدك الالكتروني..يمكنك تحديثه ببريد جديد', FailureHandling.STOP_ON_FAILURE)

...
Mobile.setText(findTestObject('User Profile/FNValue_EditProfile'), " ", 5, FailureHandling.STOP_ON_FAILURE)
Mobile.pressBack()
Mobile.scrollToText('حفظ')
Mobile.tap(findTestObject('User Profile/SaveChange_UpdateProfile'), 5, FailureHandling.STOP_ON_FAILURE)
Mobile.verifyElementText(findTestObject('ValidationMessages_UpdateAccount/EmptyName_UpdateAccount'), 'الاسم لا يمكن تركه فارغًا.', FailureHandling.STOP_ON_FAILURE)

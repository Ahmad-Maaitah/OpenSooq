...
Mobile.setText(findTestObject('User Profile/EmailValue_EditProfile'), 'sfdsfds', 0, FailureHandling.STOP_ON_FAILURE)
Mobile.pressBack()
Mobile.scrollToText('حفظ')
Mobile.tap(findTestObject('User Profile/SaveChange_UpdateProfile'), 5, FailureHandling.STOP_ON_FAILURE)
Mobile.verifyElementText(findTestObject('Object Repository/ValidationMessages_UpdateAccount/WrongEmail_UpdateAccount'), 'الرجاء إدخال بريد الكتروني صحيح', FailureHandling.STOP_ON_FAILURE)
Mobile.delay(10)

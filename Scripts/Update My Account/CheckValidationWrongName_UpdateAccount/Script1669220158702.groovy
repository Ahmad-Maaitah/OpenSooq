...
//Validation message for wrong name
...
Mobile.setText(findTestObject('User Profile/FNValue_EditProfile'), "5555", 5, FailureHandling.STOP_ON_FAILURE)
Mobile.pressBack()
Mobile.scrollToText('حفظ')
Mobile.tap(findTestObject('User Profile/SaveChange_UpdateProfile'), 5, FailureHandling.STOP_ON_FAILURE)
Mobile.verifyElementText(findTestObject('Object Repository/ValidationMessages_UpdateAccount/WrongName_UpdateProfile'), 'الرجاء إدخال الاسم بصورة صحيحة', FailureHandling.STOP_ON_FAILURE)

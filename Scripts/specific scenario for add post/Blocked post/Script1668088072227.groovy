...
Mobile.setText(findTestObject('Object Repository/Car and bikes/Add titile'), 'نسوان يلعن مخدرات', 30)

Mobile.tap(findTestObject('Car and bikes/Add des'), 30)

Mobile.setText(findTestObject('Object Repository/Car and bikes/Add des'), 'نسوان يلعن مخدرات ', 30)
...
Mobile.tap(findTestObject('Payemnt Method/call us'), 30)

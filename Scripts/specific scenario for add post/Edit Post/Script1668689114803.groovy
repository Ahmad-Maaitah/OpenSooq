...
Mobile.tap(findTestObject('Edit/Editpost'), 90)

Mobile.tap(findTestObject('Edit/delvrycp'), 90)

Mobile.tap(findTestObject('Edit/No'), 90)

Mobile.tap(findTestObject('Edit/next'), 90)

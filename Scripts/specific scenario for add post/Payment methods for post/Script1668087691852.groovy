...
WebUI.callTestCase(findTestCase('Login Page/Valid login for pyemnt method'), [:], FailureHandling.STOP_ON_FAILURE)
...
Mobile.setText(findTestObject('Object Repository/Electronics/Send exampel by name'), 'خدمات', 30)

Mobile.tap(findTestObject('Payemnt Method/Services'), 30)

Mobile.tap(findTestObject('Payemnt Method/Building and contracting'), 30)
...
Mobile.tap(findTestObject('Payemnt Method/by now button'), 30)

Mobile.tap(findTestObject('Payemnt Method/Payemnt method select'), 30)

Mobile.tap(findTestObject('Payemnt Method/By now payemnt'), 30)

Mobile.tap(findTestObject('Payemnt Method/Done Payemnt'), 30)

WebUI.delay(2)

Mobile.tap(findTestObject('Removedpost/Removed the post icon'), 90)

Mobile.tap(findTestObject('Removedpost/yes button'), 30)

Mobile.tap(findTestObject('Removedpost/opensooqicon'), 30)
